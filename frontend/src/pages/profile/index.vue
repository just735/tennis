      ...
      <view class="card coach-entry" @click="goCoachDashboard">
        <view class="coach-entry-content">
          ...
          <view class="coach-info">
            <text class="coach-title">进入教练中心</text>
            <text class="coach-desc">管理您的学员与教学数据</text>
          </view>
...
const isCoach = computed(() => user.value && user.value.role === 'coach');
...
const goCoachDashboard = () => uni.navigateTo({ url: '/pages/coach/dashboard' });
...
.page-title { font-size: 20px; font-weight: bold; display: block; }
.page-subtitle { font-size: 12px; color: rgba(255, 255, 255, 0.8); margin-top: 4px; display: block; }
.card {
...
.profile-tip { font-size: 11px; color: #b48a64; margin-top: 2px; display: block; }
...
.device-row, .goal-row, .session-row { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid #f0e7de; }
.device-row:last-child, .goal-row:last-child, .session-row:last-child { border-bottom: none; }
.device-name, .goal-title, .session-title { font-size: 14px; font-weight: bold; color: #3d2a1a; display: block; }
.device-desc, .goal-desc, .session-desc { font-size: 12px; color: #8b6a4b; margin-top: 2px; display: block; }
...
.coach-entry { cursor: pointer; }
.coach-entry-content { display: flex; align-items: center; padding: 8px 0; }
.coach-icon { font-size: 32px; margin-right: 12px; }
.coach-info { flex: 1; }
.coach-title { font-size: 15px; font-weight: bold; color: #3d2a1a; display: block; }
.coach-desc { font-size: 12px; color: #8b6a4b; margin-top: 2px; display: block; }
.coach-arrow { font-size: 16px; color: #c56a1b; }
</style>
